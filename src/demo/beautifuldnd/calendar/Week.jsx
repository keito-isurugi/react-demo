    ...
    <>
      ...
      <DragDropContext onDragEnd={onDragEnd}>
        ...
        <Box display="flex" w="100%" textAlign="center">
          {data.map((day, index) => 
          <Grid templateRows='repeat(1, 1fr)' templateColumns='repeat(7, 1fr)' h="100%" w={"50%"} border='1px' borderColor='red' key={day.id}>
            <GridItem rowSpan={1} colSpan={7} border='1px' borderColor='green'>{day.date}</GridItem>
